...
function Show() {
  ...
  const length = womenFashionProducts.length;
  const { addToCart, removeFromCart, addToWishlist, removeFromWishlist, wishlist, cart } = useCart(); 
  const navigate = useNavigate();

  const currentItems = womenFashionProducts.slice(previous, farword);
  ...
  return (
    <div className="px-16 py-10">
      ...
      <h1 className="text-4xl font-bold m-2">Fashion Products</h1>
